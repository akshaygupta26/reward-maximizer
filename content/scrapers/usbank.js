// US Bank Deals Scraper

const USBankScraper = {
  source: 'usbank',
  offersUrl: 'https://www.usbank.com/deals.html',
    ...
    for (const offer of offers) {
      if (offer.button && document.contains(offer.button)) {
        try {
          ...
          console.warn('[Reward Maximizer] Failed to click US Bank offer:', err);
        }
      }
    }
...
if (typeof window !== 'undefined') {
  window.USBankScraper = USBankScraper;
}
